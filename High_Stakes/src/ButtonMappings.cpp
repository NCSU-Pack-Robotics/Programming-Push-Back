...
//    {pros::E_CONTROLLER_DIGITAL_RIGHT, {std::nullopt, std::nullopt, std::nullopt}},
//    {pros::E_CONTROLLER_DIGITAL_X, {[] { return std::make_unique<ToggleArm>(); }, std::nullopt, std::nullopt}},
...
//    {pros::E_CONTROLLER_DIGITAL_A, {[] { return std::make_unique<ToggleClamp>(); }, std::nullopt, std::nullopt}},
//};
